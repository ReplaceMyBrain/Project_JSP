...
<body>
  ...
  <article>
  <center>
   <form action="ViewBoard.html" method="post"  align="center">
		
			제목 : <input type="text" class="form-control"  rows="1" cols="400" placeholder="제목을 입력하세요.">
			<br>
			<br>	
	 
	 		 <class="file-uploader" enctype="multipart/form-data">
	   			 <p>사진추가:</p>
		...
		<br>	
			설명 :<br>
				<textarea class="form-control" rows="16" cols="50" placeholder="입력하세요."></textarea>
				<br>
				<br>
